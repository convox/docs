---
title: "Loggly"
description: "Forward application logs to Loggly via syslog"
---

# Loggly

You can configure your application to forward its logs to Loggly.
...
Link the resource to any application whose logs you would like to forward to Loggly.
