...
Under Docker's settings, change the following configuration:

* On the **Resources** tab, increase CPUs to the halfway mark and Memory as high as you are comfortable with on your environment.
