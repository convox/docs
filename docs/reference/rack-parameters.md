...
### <a name="autoscaleextra"></a>AutoscaleExtra

The number of instances of extra capacity that autoscale should keep running.

| Default value  | `1` |

### <a name="availabilityzones"></a>AvailabilityZones
...
### <a name="buildcpu"></a>BuildCpu

How much CPU should be allocated to builds.

| Default value | `0` |

### <a name="buildinstance"></a>BuildInstance
...
### <a name="buildmemory"></a>BuildMemory
...
### <a name="buildvolumesize"></a>BuildVolumeSize
...
### <a name="cpucredits"></a>CpuCredits

The credit option for CPU usage of a T instance.

| Allowed values  | `standard`, `unlimited` |

### <a name="disablealbport80"></a>DisableALBPort80
...
### <a name="dynamodbtabledeletionprotectionenabled"></a>DynamoDbTableDeletionProtectionEnabled
...
### <a name="dynamodbtablepointintimerecoveryenabled"></a>DynamoDbTablePointInTimeRecoveryEnabled
...
### <a name="ecscontainerstoptimeout"></a>EcsContainerStopTimeout
...
### <a name="existingvpc"></a>ExistingVpc
...
### <a name="enables3versioning"></a>EnableS3Versioning
...
### <a name="enablesharedefsvolumeencryption"></a>EnableSharedEFSVolumeEncryption
...
### <a name="highavailability"></a>HighAvailability
...
```
### <a name="imdshttpputresponsehoplimit"></a>IMDSHttpPutResponseHopLimit
...
### <a name="imdshttptokens"></a>IMDSHttpTokens
...
### <a name="instancesiptoincludinwhitelisting"></a>InstancesIpToIncludInWhiteListing
...
### <a name="instancebootcommand"></a>InstanceBootCommand
...
### <a name="instancecount"></a>InstanceCount
...
### <a name="instancepolicy"></a>InstancePolicy

ARN of an additional IAM policy to add to the instance-level role.

| Default value | *<blank>* |

### <a name="instanceruncommand"></a>InstanceRunCommand
...
### <a name="instancetype"></a>InstanceType
...
### <a name="instanceupdatebatchsize"></a>InstanceUpdateBatchSize
...
### <a name="internetgateway"></a>InternetGateway
...
### <a name="loadbalanceridletimeout"></a>LoadBalancerIdleTimeout

The idle timeout value for the ALB, in seconds. The valid range is 1-4000 seconds.

| Default value  | `3600` |

### <a name="logdriver"></a>LogDriver
...
### <a name="maintaintimerstate"></a>MaintainTimerState
...
### <a name="maxavailabilityzones"></a>MaxAvailabilityZones
...
### <a name="nohaautoscaleextra"></a>NoHAAutoscaleExtra
...
### <a name="nohainstancecount"></a>NoHaInstanceCount
...
### <a name="ondemandmincount"></a>OnDemandMinCount
...
### <a name="placelambdainvpc"></a>PlaceLambdaInVpc
...
### <a name="internalroutersuffix"></a>InternalRouterSuffix
...
### <a name="privateapi"></a>PrivateApi
...
### <a name="privateapisecuritygroup"></a>PrivateApiSecurityGroup

Specify a custom security group that can connect to the Rack API when `PrivateApi=Yes`.

| Default value  | *<blank>* |

### <a name="privatebuild"></a>PrivateBuild
...
### <a name="pruneolderimagesinhour"></a>PruneOlderImagesInHour

To prune docker images older than this specified hours.

| Default value  | `96`        |

### <a name="pruneolderimagescronrunfreq"></a>PruneOlderImagesCronRunFreq
...
### <a name="routermitigationmode"></a>RouterMitigationMode
...
### <a name="routersecuritygroup"></a>RouterSecurityGroup
...
### <a name="schedulerackscaledown&schedulerackscaleup"></a>ScheduleRackScaleDown & ScheduleRackScaleUp
...
### <a name="spotinstancebid"></a>SpotInstanceBid
...
### <a name="spotfleetallowedinstancetypes"></a>SpotFleetAllowedInstanceTypes
...
### <a name="spotfleetexcludedinstancetypes"></a>SpotFleetExcludedInstanceTypes
...
### <a name="spotfleetallocationstrategy"></a>SpotFleetAllocationStrategy
...
### <a name="spotfleetmaxprice"></a>SpotFleetMaxPrice
...
### <a name="spotfleettargettype"></a>SpotFleetTargetType
