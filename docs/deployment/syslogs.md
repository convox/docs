---
title: "Syslogs"
description: "Route Convox application and Rack logs to third-party syslog destinations such as Papertrail, Datadog, and Mezmo."
---
...
* [Mezmo](https://www.mezmo.com/) (formerly LogDNA)

  * Go to [https://app.mezmo.com/pages/add-source](https://app.mezmo.com/pages/add-source), select Syslog as your provider and then use the provided url as the syslog resource Url (with `tcp+tls://`)
