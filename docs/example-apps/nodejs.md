---
title: "Node.js"
description: "Deploy a Node.js application on Convox with Docker"
---
...
Starting from the [node:20-alpine](https://hub.docker.com/_/node/) image, the [Dockerfile](https://github.com/convox-examples/nodejs/blob/master/Dockerfile) sets up a basic nodejs app by copying the app files into the container, exposing port 3000 and specifying the command to be executed.

### convox.yml

The [convox.yml](https://github.com/convox-examples/nodejs/blob/master/convox.yml) file explains how to run the application. This file only has one section for our node app.
...
2. [Connect an AWS account](/console/aws-integration)
